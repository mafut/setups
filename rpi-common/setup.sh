...
apt-get -y update
apt-get -y upgrade
apt-get -y purge avahi-daemon triggerhappy modemmanager
apt-get -y install rsyslog moreutils vim ufw raspi-config network-manager bluez bluez-tools tty-clock gpm ykcs11 tmux
